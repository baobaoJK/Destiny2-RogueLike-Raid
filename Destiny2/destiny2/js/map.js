...
// -----------------------------------------------------------------------------------------------
let maps = [
    { id: 1, name: "最后一愿", weight: 0.16, num: 1 },
    { id: 2, name: "救赎花园", weight: 0.16, num: 1 },
    { id: 3, name: "深岩墓室", weight: 0.17, num: 1 },
    { id: 4, name: "玻璃拱顶", weight: 0.17, num: 1 },
    { id: 5, name: "门徒誓约", weight: 0.17, num: 1 },
    { id: 6, name: "国王的陨落", weight: 0.17, num: 1 },
];